...
/**
 * utilidade de ficheiros
 */
const fileUtils = {
  /**
   * interacaosd
   * @request entrega de requests
   * @return entrega de objectos
   */
   ...
   * faz a busca
   * o id entao
   * @query faz uma pesquisa
   * @return ta dar a lista
   */
  ...
  /**
   * opaaad fjdf
   * @fileParams para serem salvos
   * @FOLDER_PATH parsaas dsjkf
   * @return fdsghdhdfjtyfj
   */
  ...
  /**
   * sdgfdjhfgjfgjj
   * @request dfhdfhydfhdfh
   * @setPublish {hghjdfhdfhdfhg
   * @return {vjnfgjmghjghjmgv
   */
  ...
  /**
   * ghjfgujtijgykghk
   * @file ifjsldfgsdlgjsldjgsld
   * @return sldjfsodjtfglewrngl;rng
   */
  ...
  /**
   * faaz o get hgghfh
   * @file {object} jlfgkoudshgolfdghold
   * @size {string} ljfdshngolfdsjhngfdjge
   * @return {object} lkxfcngbolfjdglhdfjgd
   */
